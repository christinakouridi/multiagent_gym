...
ENV_NAME = 'Switch4-v0'  # NOT all agents receive coordinates of all other agents in v0
MODEL_NAME = 'COMA'
...
if __name__ == '__main__':
    ...
    for episode_idx in range(1, ARGS.n_episodes + 1):
        ...
        last_actions_onehot_c = np.zeros((env.n_agents, ARGS.n_actions))
        ...
        while not done:
            ...
            for agent_id in range(env.n_agents):
                action_c = agents.act(obs=current_obs_n[agent_id], last_action=last_actions_onehot_c[agent_id],
                ...
                last_actions_onehot_c[agent_id] = action_onehot_c
